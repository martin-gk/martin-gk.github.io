...
visualConfirmBtn.addEventListener("click", function () {
  ...
  if (selectedOption === "uni") {
    ...
    videoContent.innerHTML =
      '<iframe width="560" height="315" src="https://www.youtube.com/watch?v=EaCLzFBIIpI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
    visualScreen.style.display = "none";
